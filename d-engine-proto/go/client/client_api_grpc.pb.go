...
const (
	...
	RaftClientService_WatchMembership_FullMethodName   = "/d_engine.client.RaftClientService/WatchMembership"
)
...
type RaftClientServiceClient interface {
	...
	WatchMembership(ctx context.Context, in *WatchMembershipRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MembershipSnapshot], error)
}
...
func (c *raftClientServiceClient) WatchMembership(ctx context.Context, in *WatchMembershipRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MembershipSnapshot], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RaftClientService_ServiceDesc.Streams[1], RaftClientService_WatchMembership_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WatchMembershipRequest, MembershipSnapshot]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RaftClientService_WatchMembershipClient = grpc.ServerStreamingClient[MembershipSnapshot]
...
type RaftClientServiceServer interface {
	...
	// Idempotency:
	// - Use `committed_index` as an idempotency key in the receiver.
	WatchMembership(*WatchMembershipRequest, grpc.ServerStreamingServer[MembershipSnapshot]) error
...
func (UnimplementedRaftClientServiceServer) HandleClientWrite(context.Context, *ClientWriteRequest) (*ClientResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleClientWrite not implemented")
}
func (UnimplementedRaftClientServiceServer) HandleClientRead(context.Context, *ClientReadRequest) (*ClientResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleClientRead not implemented")
}
func (UnimplementedRaftClientServiceServer) Watch(*WatchRequest, grpc.ServerStreamingServer[WatchResponse]) error {
	return status.Errorf(codes.Unimplemented, "method Watch not implemented")
}
func (UnimplementedRaftClientServiceServer) WatchMembership(*WatchMembershipRequest, grpc.ServerStreamingServer[MembershipSnapshot]) error {
	return status.Errorf(codes.Unimplemented, "method WatchMembership not implemented")
}
...
func RegisterRaftClientServiceServer(s grpc.ServiceRegistrar, srv RaftClientServiceServer) {
	// If the following call pancis, it indicates UnimplementedRaftClientServiceServer was
...
func _RaftClientService_WatchMembership_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(WatchMembershipRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RaftClientServiceServer).WatchMembership(m, &grpc.GenericServerStream[WatchMembershipRequest, MembershipSnapshot]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RaftClientService_WatchMembershipServer = grpc.ServerStreamingServer[MembershipSnapshot]
...
var RaftClientService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _RaftClientService_WatchMembership_Handler,
			ServerStreams: true,
		},
	},
