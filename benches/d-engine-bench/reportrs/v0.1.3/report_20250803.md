...
| ------------------------ | ----------- | ------------------- | ------------- | ----------------- |
| **Basic Write**          | Throughput  | 438.56 ops/s        | 157.85 ops/s  | ✅ 2.78× d-engine |
| (1 connection, 1 client) | Avg Latency | 2,279 μs            | 6,300 μs      | ✅ 64% lower      |
|                          | p99 Latency | 3,817 μs            | 16,700 μs     | ✅ 77% lower      |
| **High Concurrency**     | Throughput  | 4,176.14 ops/s      | 5,439 ops/s   | ❌ 1.30× etcd     |
| (10 conns, 100 clients)  | Avg Latency | 2,393 μs            | 18,300 μs     | ✅ 87% lower      |
|                          | p99 Latency | 6,183 μs            | 32,400 μs     | ✅ 81% lower      |
| **Linear Read**          | Throughput  | 9,358 ops/s         | 85,904 ops/s  | ❌ 9.18× etcd     |
| (Strong consistency)     | Avg Latency | 1,065 μs            | 1,100 μs      | ✅ 3% lower       |
|                          | p99 Latency | 1,410 μs            | 3,200 μs      | ✅ 56% lower      |
| **Sequential Read**      | Throughput  | 38,917 ops/s        | 124,631 ops/s | ❌ 3.20× etcd     |
| (Eventual consistency)   | Avg Latency | 255 μs              | 700 μs        | ✅ 64% lower      |
|                          | p99 Latency | 572 μs              | 2,800 μs      | ✅ 80% lower      |
