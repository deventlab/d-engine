...
| ------------------------ | ----------- | ------------------- | ------------- | ----------------- |
| **Basic Write**          | Throughput  | 358.28 ops/s        | 157.85 ops/s  | ✅ 2.27× d-engine |
| (1 connection, 1 client) | Avg Latency | 2,789 μs            | 6,300 μs      | ✅ 56% lower      |
|                          | p99 Latency | 5,719 μs            | 16,700 μs     | ✅ 66% lower      |
| **High Concurrency**     | Throughput  | 4,088.54 ops/s      | 5,439 ops/s   | ❌ 1.33× etcd     |
| (10 conns, 100 clients)  | Avg Latency | 2,443 μs            | 18,300 μs     | ✅ 87% lower      |
|                          | p99 Latency | 7,511 μs            | 32,400 μs     | ✅ 77% lower      |
| **Linear Read**          | Throughput  | 6,739 ops/s         | 85,904 ops/s  | ❌ 12.7× etcd     |
| (Strong consistency)     | Avg Latency | 1,480 μs            | 1,100 μs      | ❌ 34% higher     |
|                          | p99 Latency | 2,953 μs            | 3,200 μs      | ✅ 8% lower       |
| **Sequential Read**      | Throughput  | 39,156 ops/s        | 124,631 ops/s | ❌ 3.18× etcd     |
| (Eventual consistency)   | Avg Latency | 254 μs              | 700 μs        | ✅ 64% lower      |
|                          | p99 Latency | 579 μs              | 2,800 μs      | ✅ 79% lower      |
