...
| **Test Case**            | **Metric**  | **sled v0.34.7** | **rocksdb v0.24.0** | **etcd 3.5**  | **Advantage**                |
| ------------------------ | ----------- | ---------------- | ------------------- | ------------- | ---------------------------- |
| **Basic Write**          | Throughput  | 387.30 ops/s     | 423.61 ops/s        | 157.85 ops/s  | ✅ 2.68× RocksDB vs etcd     |
| (1 connection, 1 client) | Avg Latency | 2,580 μs         | 2,359 μs            | 6,300 μs      | ✅ 63% lower RocksDB vs etcd |
|                          | p99 Latency | 5,227 μs         | 3,915 μs            | 16,700 μs     | ✅ 77% lower RocksDB vs etcd |
| **High Concurrency**     | Throughput  | 3,889.77 ops/s   | 3,597.27 ops/s      | 5,439 ops/s   | ❌ 1.51× etcd vs RocksDB     |
| (10 conns, 100 clients)  | Avg Latency | 2,568 μs         | 2,774 μs            | 18,300 μs     | ✅ 85% lower RocksDB vs etcd |
|                          | p99 Latency | 12,103 μs        | 5,999 μs            | 32,400 μs     | ✅ 81% lower RocksDB vs etcd |
| **Linear Read**          | Throughput  | 9,648.43 ops/s   | 9,999 ops/s         | 85,904 ops/s  | ❌ 8.59× etcd vs RocksDB     |
| (Strong consistency)     | Avg Latency | 1,033 μs         | 997 μs              | 1,100 μs      | ✅ 9% lower RocksDB vs etcd  |
|                          | p99 Latency | 2,027 μs         | 1,498 μs            | 3,200 μs      | ✅ 53% lower RocksDB vs etcd |
| **Sequential Read**      | Throughput  | 42,919.47 ops/s  | 42,002 ops/s        | 124,631 ops/s | ❌ 2.97× etcd vs RocksDB     |
| (Eventual consistency)   | Avg Latency | 231 μs           | 236 μs              | 700 μs        | ✅ 66% lower RocksDB vs etcd |
|                          | p99 Latency | 583 μs           | 514 μs              | 2,800 μs      | ✅ 82% lower RocksDB vs etcd |
