...
// ============================================================================
// Unit Tests for Ticket #238: Optimize LinearizableRead
// ============================================================================
...
async fn test_calculate_read_index_noop_ahead() {
    ...
    let context = setup_raft_components("/tmp/test_calculate_read_index_noop_ahead", None, false);
...
async fn test_calculate_read_index_commit_ahead() {
    // Given: Leader with commit_index > noop_log_id
    let context = setup_raft_components("/tmp/test_calculate_read_index_commit_ahead", None, false);
    let mut state = LeaderState::<MockTypeConfig>::new(1, context.arc_node_config.clone());
...
async fn test_calculate_read_index_without_noop() {
    ...
    let context = setup_raft_components("/tmp/test_calculate_read_index_without_noop", None, false);
    let mut state = LeaderState::<MockTypeConfig>::new(1, context.arc_node_config.clone());
    state.update_commit_index(100).expect("should succeed");
...
async fn test_wait_until_applied_needs_wait() {
    ...
    let context = setup_raft_components("/tmp/test_wait_until_applied_needs_wait", None, false);
    let state = LeaderState::<MockTypeConfig>::new(1, context.arc_node_config.clone());
...
async fn test_wait_until_applied_no_wait() {
    ...
    let context = setup_raft_components("/tmp/test_wait_until_applied_no_wait", None, false);
    let state = LeaderState::<MockTypeConfig>::new(1, context.arc_node_config.clone());
    let target_index = 100;
